{{-- resources/views/admin/recommended-places/edit.blade.php --}}
...
<div>
    ...
    <div class="mb-6 flex items-center justify-between">
        ...
        <a href="{{ route('admin.recommended-places.index') }}" 
    ...
    <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
        <form action="{{ route('admin.recommended-places.update', $recommendedPlace) }}" method="POST" id="place-form">
            @csrf
            @method('PUT')
            ...
            <div class="px-6 py-4 bg-gray-50 border-t border-gray-200 flex gap-3">
                ...
                <a href="{{ route('admin.recommended-places.index') }}" class="px-5 py-2 bg-gray-200 text-gray-700 rounded-lg text-sm font-medium hover:bg-gray-300 transition">
                    Cancel
                </a>
            </div>
        </form>
