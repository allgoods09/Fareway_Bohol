{{-- resources/views/moderator/fare-rates/edit.blade.php --}}
...
<div>
    ...
    <div class="mb-6 flex items-center justify-between">
        <div>
            ...
            <p class="text-gray-500 text-sm mt-1">Update fare rates for {{ $fareRate->name }}</p>
        </div>
    ...
    <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
        <form action="{{ route('moderator.fare-rates.update', $fareRate) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="px-6 py-4 bg-gray-50 border-t border-gray-200 flex gap-3">
                ...
                <a href="{{ route('moderator.fare-rates.index') }}" class="px-5 py-2 bg-gray-200 text-gray-700 rounded-lg text-sm font-medium hover:bg-gray-300 transition">
                    Cancel
                </a>
            </div>
        </form>
